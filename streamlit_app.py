...
if ingredients_list:
    ...
    st.write(Order_name + ': ' + ingredients_string)
    ...
    if time_to_insert:
        ...
        st.success('Your smoothie is ordred, ' + Order_name +'!', icon="✅")
smoothiefroot_response = requests.get("https://my.smoothiefroot.com/api/fruit/ingredients_string")
